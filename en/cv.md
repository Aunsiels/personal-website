...
<script type="application/ld+json">
{
  ...
  "@type": "Person",
  "name": "Julien Romero",
  "jobTitle": "Associate Professor in Artificial Intelligence",
  "affiliation": {
    "@type": "Organization",
  ...
  "url": "{{ site.url | default: 'https://julienromero.fr' }}{{ '/en/cv' | relative_url }}",
  "sameAs": [
...
- 📍 Paris, France  
- ✉️ <a href="mailto:julien [DOT] romero [AT] telecom-sudparis.eu">julien [DOT] romero [AT] telecom-sudparis.eu</a>  
